...
namespace WebERP.Controllers
{
    public class LocalsController : Controller
    {
        ...
        public LocalsController(MasterDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("LocalId,LocalName")] Local local)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LocalId,LocalName")] Local local)
        {
            if (id != local.LocalId)
            {
                return NotFound();
